...
public class FocusChecker : MonoBehaviour
{
    ...
    public GameObject focus
    {
        get
        {
            ...
            {
                worldPosition = MyGrid._instance.GroundGridToWorld(MyGrid._instance.WorldToGroundGrid(focusPoint.position));
    ...
    //     Gizmos.DrawWireCube(worldPosition + Vector3.up * MyGrid._instance.cellSize * 0.5f, Vector3.one * MyGrid._instance.cellSize);
    // }
    }
}
